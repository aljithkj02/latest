...
const Landing = () => {
    ...
    const faqs = [
        ...
        { q: "ഈ കോഴ്സ് എത്ര ദിവസത്തേക്കാണ്?", a: "ഇതൊരു 4 ആഴ്ചത്തെ തീവ്രമായ പരിശീലനമാണ്. പക്ഷെ കോഴ്സ് കഴിഞ്ഞാലും ഞങ്ങളുടെ കമ്മ്യൂണിറ്റിയുടെ സഹായം നിനക്ക് ജീവിതകാലം മുഴുവൻ ലഭിക്കും." },
